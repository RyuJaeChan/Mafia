...
GameRoomInfo::GameRoomInfo() : id(0), liveCnt(0), deadUser(), votedUser(), actionResult(false), userList(vector<UserInfo>())
{
}

GameRoomInfo::GameRoomInfo(int _id) : id(_id), liveCnt(0), deadUser(), votedUser(), actionResult(false), userList(vector<UserInfo>())
{
}
